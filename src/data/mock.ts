...
export const mockOrders: Order[] = [
  {
    id: "QB-8821", customerId: "C001", customerName: "Rahul Kumar",
    customerPhone: "+91 94471-12345", shopId: "S001", shopName: "Fresh Mart Calicut",
    items: [
      { id: "I1", productName: "Amul Gold Milk 500ml", quantity: 2, unitPrice: 29, totalPrice: 58 },
      { id: "I2", productName: "Tata Tea Gold 250g", quantity: 1, unitPrice: 99, totalPrice: 99 },
      { id: "I3", productName: "Fortune Rice Bran Oil 1L", quantity: 1, unitPrice: 135, totalPrice: 135 },
      { id: "I4", productName: "Lay's Classic 26g", quantity: 3, unitPrice: 20, totalPrice: 60 },
      { id: "I5", productName: "Dove Soap 100g", quantity: 1, unitPrice: 52, totalPrice: 52 },
      { id: "I6", productName: "Haldiram's Namkeen 200g", quantity: 1, unitPrice: 72, totalPrice: 72 },
    ],
    itemCount: 6, subtotal: 476, deliveryFee: 20, platformFee: 5, total: 501,
  ...
  {
    id: "QB-8820", customerId: "C002", customerName: "Priya Menon",
    customerPhone: "+91 98461-54321", shopId: "S002", shopName: "Green Valley Store",
    items: [
      { id: "I1", productName: "Nescafé Classic 50g", quantity: 1, unitPrice: 160, totalPrice: 160 },
      { id: "I2", productName: "Amul Butter 500g", quantity: 1, unitPrice: 265, totalPrice: 265 },
      { id: "I3", productName: "India Gate Basmati 5kg", quantity: 1, unitPrice: 449, totalPrice: 449 },
      { id: "I4", productName: "Parle-G Biscuits 800g", quantity: 2, unitPrice: 45, totalPrice: 90 },
    ],
    itemCount: 4, subtotal: 964, deliveryFee: 20, platformFee: 5, total: 989,
    status: "out_for_delivery", paymentMethod: "card",
    deliveryAddress: "Opp. Govt Hospital, College Road, Malappuram 676505",
    landmark: "White building, 2nd floor",
...
export const mockShops: Shop[] = [
  ...
  { id: "S004", shopName: "QB Bazaar Manjeri", ownerName: "Mary Thomas", phone: "+91 99471-33445", email: "mary@qbbazaar.in", address: "Church Street, Manjeri, Malappuram 676121", gstNumber: "32UVWXY3456K4L8", fssaiNumber: "11224999000353", commissionRate: 9, status: "approved", totalOrders: 1760, totalRevenue: 543000, rating: 4.5, isLive: true, joinedAt: "2024-01-15T00:00:00Z" },
  ...
  // Pending
  { id: "S006", shopName: "Kerala Supermarket", ownerName: "Anil Raj", phone: "+91 94471-99001", email: "anil@kmart.in", address: "Main Road, Perinthalmanna 679322", gstNumber: "32ABFDE1234F1A5", commissionRate: 8, status: "pending", totalOrders: 0, totalRevenue: 0, rating: 0, isLive: false, joinedAt: "2024-04-18T00:00:00Z" },
  { id: "S007", shopName: "Fresh Picks Store", ownerName: "Rajan Nair", phone: "+91 98461-11234", email: "rajan@freshpicks.in", address: "College Road, Malappuram 676505", gstNumber: "32XYZCD5678G2A6", commissionRate: 8, status: "pending", totalOrders: 0, totalRevenue: 0, rating: 0, isLive: false, joinedAt: "2024-04-19T00:00:00Z" },
  { id: "S008", shopName: "City Grocery Hub", ownerName: "Sreejith M", phone: "+91 91481-22334", email: "sreejith@cityhub.in", address: "Town Centre, Tirur 676101", gstNumber: "32PQRTU9012I3A7", commissionRate: 8, status: "pending", totalOrders: 0, totalRevenue: 0, rating: 0, isLive: false, joinedAt: "2024-04-19T00:00:00Z" },
  { id: "S009", shopName: "Velankanni Stores", ownerName: "Basheer K", phone: "+91 99471-44556", email: "basheer@velankanni.in", address: "Market Road, Kottakkal 676503", gstNumber: "32UVWAB3456K4A8", commissionRate: 8, status: "pending", totalOrders: 0, totalRevenue: 0, rating: 0, isLive: false, joinedAt: "2024-04-20T00:00:00Z" },
  { id: "S010", shopName: "Daily Fresh Mart", ownerName: "Jose Mathew", phone: "+91 97471-66778", email: "jose@dfmart.in", address: "Near Railway Station, Manjeri 676121", gstNumber: "32MNOPZ7890M5A9", commissionRate: 8, status: "pending", totalOrders: 0, totalRevenue: 0, rating: 0, isLive: false, joinedAt: "2024-04-20T00:00:00Z" },
  // Rejected
  { id: "S011", shopName: "Old Town Grocery", ownerName: "Ravi Kumar", phone: "+91 94471-88990", email: "ravi@otg.in", address: "Old Town, Calicut 673001", gstNumber: "32ABCDE9999F1Z5", commissionRate: 0, status: "rejected", totalOrders: 0, totalRevenue: 0, rating: 0, isLive: false, joinedAt: "2024-04-10T00:00:00Z" },
];
...
export const mockCustomers: Customer[] = [
  {
    ...
    addresses: ["14/B Railway Colony, Perinthalmanna, Malappuram 679322", "Flat 4A, Highrise Apts, Calicut"],
  },
  {
    id: "C002",
    name: "Priya Menon",
    email: "priya.menon@outlook.com",
    phone: "+91 98461-54321",
    status: "active",
    totalOrders: 15,
    totalSpent: 8720,
  ...
  },
  {
    ...
    phone: "+91 99471-33445",
    status: "active",
    totalOrders: 9,
    totalSpent: 4120,
    joinedAt: "2024-01-18T10:45:00Z",
    addresses: ["Church Street, Manjeri, Malappuram 676121"],
  },
  {
    id: "C005",
    name: "Suresh Nair",
